...
class GreenCalculatorController {
    ...
    lazy var allQuestions: [Question] = [
        ...
        Question(text: "Do you have any of these energy saving improvements in your home? (Select all that apply)", category: .house, possibleAnswers: EnergySavingImprovement.possibleAnswers, questionType: .multipleAnswer),
        Question(text: "Which of the following do you recycle? (Select all that apply)", category: .house, possibleAnswers: WasteRecycling.possibleAnswers, questionType: .multipleAnswer),
